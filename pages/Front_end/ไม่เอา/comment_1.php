<?php
    ...
    $sql = "SELECT * FROM evaluation eva
    left join article art on art.article_id = eva.evaluation_id
    left join assessment ass on ass.assessment_id = eva.assessment_id";    
...
<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm"></div>
        ...
        <div class="card" >
            <div class="card-body">
                <label>หลังจากผู้ส่ง comment... ---> รวม comment</label>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">รายการคอมเมนต์บทความ</li>
                        </ol>
                    </nav>     
                            ...
                            <table class="table table-striped">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col" style="width: 15%">สาขา</th>
                                        <th scope="col" style="width: 15%">การประเมิน</th>
                                    ...
                                    <?php $selectall=1; while($row = $result->fetch_assoc()){ ?>
                                      <tr>
                                        ...
                                        <td style="padding-bottom: 6px; padding-top: 6px;">สาขาวิชา</td>
                                        <td style="padding-bottom: 6px; padding-top: 6px;"><?php echo $row["assessment_type"] ?></td>
                                        <td style="padding-bottom: 6px; padding-top: 6px;"><a href="../files_comment/<?php echo $row["comment_eva"] ?>">ดาวน์โหลด</a></td>
