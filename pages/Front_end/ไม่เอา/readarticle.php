...
<div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm"></div>
        ...
        <div class="card" >
            <div class="card-body">
                <label>รอให้ผู้ทรงวุฒิฯ อ่านบทความ... ---> เพื่อประเมิน</label>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page">รายการบทความวิชาการ (รอการอ่าน)</li>
                        </ol>
                    </nav>     
                            ...
                            <table class="table table-striped">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col" style="width: 15%" >วันที</th>                               
                                      </tr>
                                    </thead>
                                    <tbody>
                                    <?php $selectread=1; while($row = $result->fetch_assoc()){ ?>
                                      <tr>
                                        <th scope="row" style="padding-bottom: 6px; padding-top: 6px;"><?php echo $selectread; ?></th>
                                        ...
                                        <td style="padding-bottom: 6px; padding-top: 6px;"><a href="assessment.php?article_id=<?php echo $row['article_id']; ?>" <button class="btn btn-outline-secondary btn-sm">ประเมิน</button></a></td>
