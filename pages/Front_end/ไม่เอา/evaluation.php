                                    ...
                                    <table class="table table-striped">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col" style="width: 15%">ผลการประเมิน</th>
                                                <th scope="col" style="width: 20%">ผลการตรวจแก้</th>
                                                <th scope="col" style="width: 15%">ผลการตีพิมพ์</th>                              
                                              </tr>
                                            </thead>
                                            <tbody>
                                            <?php $inarticle=1; while($row = $result->fetch_assoc()){ ?>
                                              <tr>
                                                <th scope="row"><?php echo $inarticle; ?></th>
