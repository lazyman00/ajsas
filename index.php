...
<body>
    ...
    <div class="container">
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 28px;font-weight: 500;color: #555;text-align:center">วารสารวิชาการวิทยาศาสตร์และวิทยาศาสตร์ประยุกต์ </h3>
        </div>
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 18px;font-weight: 500;color: #555;text-align:center">คณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏอุตรดิตถ์ </h3>
        </div><br>
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 28px;font-weight: 500;color: #006400;text-align:center">Academic Journal of Science and Applied Science  </h3>
        </div>
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 18px;font-weight: 500;color: #555;text-align:center">Faculty of Science and Technology, Uttaradit Rajabhat University </h3>
        </div><br><br>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 28px;font-weight: 500;color: #555;text-align:center">กำหนดการจัดทำวารสารแต่ละปี</h3>
        </div>
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 18px;font-weight: 500;color: #555;text-align:center">ฉบับที่ 1 มกราคม – มิถุนายน</h3>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-md-12">
            <h3 style="font-family: prompt;font-size: 18px;font-weight: 500;color: #555;text-align:center">ฉบับที่ 2 กรกฎาคม – ธันวาคม</h3>
        </div>
    </div>
...
<div class="modal fade bd-example-modal-sm" id="loginform" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form class="login" id="loginA" name="loginA" method="post" >
                <div class="modal-body">

                    <div class="form-group">
                        <label for="exampleInputEmail1">อีเมล</label>
                        <input type="text" name="user" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="อีเมล">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">รหัสผ่าน</label>
                        <input type="password" name="pass" class="form-control" id="exampleInputPassword1" placeholder="รหัสผ่าน">
                    </div>
...
<div class="modal fade bd-example-modal-sm" id="msg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="alert alert-warning alert-dismissible" role="alert">
            ...
            <strong>ข้อความ!</strong> <span id="txt">ชื่อผู้ใช้หรือรหัสผ่านผิดพลาด กรุณากรอกข้อมูลอีกครั้ง!!</span>
        </div>
    </div>
</div>
    ...
    $(document).ready(function () {
        ...
        $( "#loginA" ).validate( {
            ...
            submitHandler: function(e) {
                ...
                setTimeout(function(){ 
                    $.post('login/sql_login.php',$('#loginA').serialize(),function(response){
                    // alert(response);
                    $('#view').html(response);
                    if(response==1){
