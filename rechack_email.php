...
$username_connect = "ajuru";
    ...
    $sql_2 = sprintf("SELECT `abstract_en` FROM `article` WHERE `article_id` = %s ",GetSQLValueString($_GET['i'], 'text'));
    $query_2 = $conn->query($sql_2);
    $row_2 = $query_1->fetch_assoc();
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
                ...
                <div class="card-body">
                   <form id="form_add_mange_user_user">
                    <div class="container" style="padding-left: 0px;padding-right: 0px;">
                        <p class="utxt"><b>Dear <?php echo $row['pre_en']; ?> <?php echo $row['name_en']; ?> <?php echo $row['surname_en']; ?> </b></p>
                        <p style="text-indent: 50px;"><b>Are you willing to check the article  ( <?php echo $_GET['e']; ?> ) ?</b></p>
                        ...
                        ?>
                        <p><b>Abstract</b></p>
                        <p style="text-indent: 50px;"><?php echo $row_2['abstract_en']; ?></p>
